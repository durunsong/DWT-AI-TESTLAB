...
export function buildCaseYamlAssistPrompt(input: CaseYamlAssistPromptInput): string {
  ...
  return [
    ...
    "admin 个人信息/修改资料场景登录后直接打开 ${session.login_url}#/admin/sys/perinfo，并复用 admin_profile_username、admin_profile_password、admin_profile_save、admin_profile_success_message；不要生成点击“系统”“个人信息”菜单或等待“编辑个人信息”的脆弱 XPath。",
